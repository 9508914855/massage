...
shareButton.addEventListener('click', () => {
    if (navigator.share) {
        ...
        const token = generateToken();
        const shareUrl = `${window.location.origin}${window.location.pathname}?t=${token}&m=${encodeURIComponent(messageElement.innerText)}`;
