...
// create a function to generate a short URL using the TinyURL API
const generateShortUrl = async (longUrl) => {
  const apiUrl = `https://api.tinyurl.com/create?url=${longUrl}`;
...
shareButton.addEventListener('click', async () => {
  ...
  // generate a short URL for the share link
  ...
  if (navigator.share) {
    ...
    prompt('Copy this URL and share it with others:', shortUrl || shareUrl);
  }
});
